 ...
 */
@WebServlet("/wylogowany")
public class Wylogowany extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String) session.getAttribute("czyzalogowany")!="1") {
			request.setAttribute("info", "wylogowany");
			request.getRequestDispatcher("/WEB-INF/views/welcome.jsp?info=wylogowany").forward(request, response);
		}else {
